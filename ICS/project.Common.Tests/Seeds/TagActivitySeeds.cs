...
{
    public static readonly TagActivityEntity TagActivityEmptyEntity = new()
    {
        Id = default,
        TagId = default,
        Tag = default,
    ...
    public static readonly TagActivityEntity DebuggingDevelopment = new()
    {
        ...
        ActivityId = ActivitySeeds.Development_Without_TagActivities.Id,
        Activity = ActivitySeeds.Development_Without_TagActivities
    };
